...
from src.handlers.websocket_handlers import websocket_handlers
...
class QMSEngine:
	def __init__(self):
		...
		self.router_of_websocket_handlers = APIRouter()

	def run_case(self):
		get_handlers(self.router_of_get_handlers)
		post_handlers(self.router_of_post_handlers)
		websocket_handlers(self.router_of_websocket_handlers)